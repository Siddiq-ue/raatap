...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#6675FF] text-white mt-auto">
      {/* Main Footer Content */}
      <div className="w-full px-6 md:px-12 lg:px-20 py-20 md:py-28">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-14 lg:gap-12">
          {/* Left Section - Description & Social */}
          <div className="flex-1 max-w-md">
            <p className="text-white/90 text-base leading-relaxed font-normal">
              Ask the community, get opportunities and enjoy the way of living
              with raatap
            </p>
          ...
          <div className="flex flex-wrap gap-12 md:gap-16 lg:gap-20">
            ...
            <div className="flex flex-col gap-3">
              <h3 className="text-lg font-medium mb-1">Legal</h3>
              <Link
                href="/privacy_policy"
      ...
      <div className="w-full border-t border-white/20 py-4">
        <p className="text-center text-white/70 text-sm">
          © 2025 Raatap &nbsp; ALL RIGHTS RESERVED
        </p>
      </div>
    </footer>
  );
